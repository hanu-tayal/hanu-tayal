...
**Principal Product Manager → Founder** | GenAI · Developer Tools · Code Modernization

*Ex-AWS (Amazon Q, CodeCatalyst) · Ex-Microsoft (Teams Platform) · Ex-Amazon (Prime)*
...
- **ReRite** — Founder & PM · AI-powered legacy code modernization (COBOL, C# → TypeScript) · $250B market
- **AWS** — Principal PM (Technical) · Amazon Q (GenAI dev), CodeCatalyst, CI/CD · Led 75-engineer org
- **Microsoft** — Senior PM · Teams Developer Platform · Apps for 50M+ SMBs (Stripe, PayPal)
- **Amazon** — Senior PM · Prime & Retail · 1-day delivery expansion, FastTrack analytics
- **MBA** Indiana · **B.Tech** Computer Science · **ML Certificate** UW · **Resident Expert** AI House Seattle
...
`TypeScript` `Python` `React` `AI/ML` `Claude` `LLMs` `Code Analysis` `Product Management` `AWS` `Developer Tools`
